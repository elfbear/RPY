...
***********************************************************************/
int RPYfmm(double  beta, int s, int accuracy, int nparts, 
  ...
  *************************************************************************/
  test_init( beta, s,  accuracy, nparts,  &charge, &pot, &field,
 ...
 *************************************************/
  ...
  for(i = 0; i < 3; i++){
	...
	for(m=0; m<nparts; m++){
		fprintf(fp1, "%f\n", pot[m]);
		fprintf(fp2, "%f \t  %f \t %f\n", field[3*m], field[3*m+1], field[3*m+2]);
		fprintf(fp3, "%f \t %f \t %f \t %f \t %f \t %f \n", dxx[m], dyy[m], dzz[m],dxy[m],dxz[m], dyz[m]);
